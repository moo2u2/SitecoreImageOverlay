    ...
    public class ImageWithOverlay : Image
    {
        ...
        protected override void DoRender(HtmlTextWriter output)
        {
            ...
            if (mediaItem != null)
            {
                ...
                overlayDimensions = "left:" + (Math.Round(coords[0] * scale) + padding[0]) + "px;top:" + (Math.Round(coords[1] * scale) + padding[1]) + "px;";
            }
            else
            {
                overlayDimensions = "left:" + padding[0] + "px;top:" + padding[1] + "px;";
            }
            output.Write("<img src=\"/Content/images/overlay.png\" style=\"position:absolute;" + overlayDimensions + "width:30px;\">");
